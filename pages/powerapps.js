...
import {powerappsSkills, powerappsExperiences, reactProjects, reactNativeProjects, powerappsProjects, nodeProjects, nocodeProjects} from '../profile'
                ...
                <div className="card card-body bg-primary">
                    <div className="row">
                        ...
                        <div className="col-md-12 mt-3">
                            <h3 className="text-center text-light"> PowerApps</h3>
                            <hr className="bg-white "/>
                        </div>        
                        <div className="col-md-3 p-2" />

                        {
                              powerappsProjects.map(({name,description,image,url},i) => (
