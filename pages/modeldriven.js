...
import {powerappsSkills, powerappsExperiences, reactProjects, reactNativeProjects, modelDrivenProjects, nodeProjects, nocodeProjects} from '../profile'
          ...
          <div className="col-md-12">
                <div className="card card-body bg-primary">
                    <div className="row">
                        ...
                        {
                              modelDrivenProjects.map(({name,description,image,url},i) => (
